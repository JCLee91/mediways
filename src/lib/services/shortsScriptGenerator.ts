...
★ 블로그 주제에 맞는 시각적 요소
★ 텍스트/글자 생성 절대 금지 (AI가 글자를 깨뜨림)

【형식】
"Quick cuts, fast-paced: [장면1 3단어], [장면2 3단어], [장면3 3단어]. Korean [의료시설], [감정/분위기], cinematic 4K, no text, no titles, no captions"
...
❌ videoPrompt에 텍스트/글자/자막 생성 요청 금지 (반드시 "no text" 포함)
